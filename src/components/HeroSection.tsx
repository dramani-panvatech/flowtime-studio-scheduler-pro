        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
          ...
          <Dialog>
            <DialogTrigger asChild>
              <Button variant="outline" size="lg" className="border-2 border-purple-300 text-purple-700 hover:bg-purple-50 px-8 py-4 text-lg rounded-full shadow-lg transform hover:scale-105 transition-all duration-200 font-['Poppins']">
                Watch Demo
              </Button>
            </DialogTrigger>
